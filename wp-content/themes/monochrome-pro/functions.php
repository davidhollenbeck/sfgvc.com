...
function monochrome_enqueue_scripts_styles() {
	...
	wp_enqueue_script( 'dh-load-fonts', get_stylesheet_directory_uri() . '/js/load-fonts.js', true);
...
// Define objects and global vars

class SFG_HomeButton {
    public $image_url;
    public $text;
    public $icon;
    public $link;
    ...
    public function __construct( $ImageUrl, $Text, $Icon, $Link, $Target = "_blank")
    {
...
class SFG_Advert {
    ...
    public function __construct( $ImageUrl, $Text, $Link, $Target = "_blank")
    {
        $this->image_url = $ImageUrl;
        $this->text = $Text;
        $this->link = $Link;
...
class SFG_PDF {
    ...
    public function __construct($MediaUrl, $Link, $Orientation, $Target = "_blank")
    {
...
function sfg_homepage()
{
    ...
    $db_buttons = array(
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_1.png", "one", get_template_directory() . "/assets/Icon_1.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_2.png", "two", get_template_directory() . "/assets/Icon_2.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_3.png", "three", get_template_directory() . "/assets/Icon_3.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_4.png", "four", get_template_directory() . "/assets/Icon_4.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_5.png", "five", get_template_directory() . "/assets/Icon_5.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_6.png", "six", get_template_directory() . "/assets/Icon_6.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_7.png", "seven", get_template_directory() . "/assets/Icon_7.png", "#"),
        new SFG_HomeButton(get_stylesheet_directory_uri() . "/assets/Image_8.png", "eight", get_template_directory() . "/assets/Icon_8.png", "#")
    );
