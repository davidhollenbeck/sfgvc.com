 ...
 */
function sfg_customizer_get_default_link_color() {
	return '#c3251d';
}
 ...
 */
function sfg_customizer_get_default_accent_color() {
	return '#c3251d';
}
 ...
 */
function sfg_color_contrast( $color ) {
 ...
 */
function sfg_color_brightness( $color, $change ) {
