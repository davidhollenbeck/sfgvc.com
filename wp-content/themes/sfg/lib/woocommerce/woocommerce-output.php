...
add_filter( 'woocommerce_enqueue_styles', 'sfg_woocommerce_styles' );
/**
 ...
 */
function sfg_woocommerce_styles( $enqueue_styles ) {
...
add_action( 'wp_enqueue_scripts', 'sfg_woocommerce_css' );
/**
...
function sfg_woocommerce_css() {
	...
	$color_link = get_theme_mod( 'sfg_link_color', sfg_customizer_get_default_link_color() );
	$color_accent = get_theme_mod( 'sfg_accent_color', sfg_customizer_get_default_accent_color() );

	$woo_css = '';

	$woo_css .= ( sfg_customizer_get_default_link_color() !== $color_link ) ? sprintf( '
	...
	$woo_css .= ( sfg_customizer_get_default_accent_color() !== $color_accent ) ? sprintf( '
	...
	', $color_accent, sfg_color_contrast( $color_accent ) ) : '';
